  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Faol Eslatmalar</li>
        </ol>
      </nav>
    </div>
    <section class="section dashboard">
        <div class="row">
          ...
          <div class="card ">
              <div class="card-body">
                <h5 class="card-title">Faol <span>| Eslatmalar</span></h5>
                <div class="table-responsive text-nowrap">
				    <table class="table table-bordered border-primary table-striped my_table_search">
                        ...
                        <tbody>
                        <?php
                          $sqles = "SELECT * FROM `user_student_eslatma` JOIN `user_student` ON user_student_eslatma.UserID=user_student.StudentID WHERE user_student_eslatma.Date>='".date("Y-m-d")."'";
                          ...
                          if($reses->num_rows>0){
                            ...
                            while ($rowes=$reses->fetch_assoc()) {
                              echo "<tr>
                                ...
                                <td>".$rowes['Matn']."</td>
                                <td>".$rowes['Date']."</td>
                                <td class='text-center'><a href='./tashrif_eye.php?StudentID=".$rowes['UserID']."'><i class='bi bi-arrow-right-circle'></i></a></td>
                              </tr>";
                              $i++;
                            }
                          }
