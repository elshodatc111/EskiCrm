                          ...
                          <?php
                            ...
                            if($res->num_rows>0){
                              ...
                              while ($row=$res->fetch_assoc()) {
                                $sql1 = "SELECT * FROM `guruh_users` WHERE `UserID`='".$row['StudentID']."'";
                                ...
                                echo "<tr>
                                  <td>".$i."</td>
                                  <td>".$row['FIO']."</td>
                                  <td>".$row['AddresName']."</td>
                                  <td>".$row['Phone']."</td>
                                  <td>".$count."</td>
                                  <td>";
                                    echo "<a href='tashrif_eye.php?userid=".$row['StudentID']."' class='px-1'><i class='bi bi-eye'></i></a>";
                                    if($count===0){
                                      echo "<a href='php/tashrif.php?tashrifdel=true&userid=".$row['StudentID']."' class='px-1'><i class='bi bi-trash-fill'></i></a>";
                                    }
                                  echo "</td>
                                </tr>";
                                $i++;
