                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive text-nowrap">
                      <table class="table text-center table-bordered" id="datatable">
                        ...
                        <tbody>
                          <?php
                            $sql = "SELECT * FROM `moliya` WHERE `Type`='true'";
                            ...
                            if($res->num_rows>0){
                              ...
                              while($row=$res->fetch_assoc()){
                                echo "<tr>
                                  ...
                                  <td>".$row['ChiqimVaqt']."</td>
                                  <td>".$row['TypeTulov']."</td>
                                  <td>".$row['Izoh']."</td>
                                  <td>".$row['Meneger']."</td>
                                  <td>".$row['Tasdiqlandi']."</td>
                                  <td>".$row['Xisobchi']."</td>
                                  <td><a href='php/moliya.php?miliyadel=true&id=".$row['id']."' class='px-1'><i class='bi bi-trash-fill'></i></a></td>
                                </tr>";
                                $i++;
                              }
                            }
